...
async def synthesis_run(chain, chain_results):
            ...
            persona1_opinion = parsed_result.get("persona1_summarized_opinion", "No opinion provided")
            persona2_opinion = parsed_result.get("persona2_summarized_opinion", "No opinion provided")
            persona3_opinion = parsed_result.get("persona3_summarized_opinion", "No opinion provided")
