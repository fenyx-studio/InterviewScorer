...
class ChainCreator:
    ...
    def create(self):
        ...
        "score":"score", "perspective":"perspective on interview answer", "two_pieces_tactical_advice":"two distinct pieces of tactical advice for a better answer", "persona_note":"what the persona would note about the interviewee's answer", "stricter_score":"score", "confidence":"confidence in score and evaluation of answer (1-5)"
        The above six keys MUST be returned as a JSON object. THIS IS VERY IMPORTANT and CRITICAL. The four keys in the JSON should be "score", "perspective", "two_pieces_tactical_advice", and "persona_note". The "stricture_score" should be a much more accurate score and much more strict than the "score". Both "score" & "stricter_score" should be a value from 1-10. The "confidence" should be a confidence score from 1-5 in the evaluation of the answer and score.
