...
class InterviewChains:
    ...
    def get_synthesis_chain(self, llm):
        ...
        REQUIRED: Return the following as a valid JSON object with structure following this format:
        "persona1_summarized_opinion":"summarized opinion from persona 1", "persona2_summarized_opinion":"summarized opinion from persona 2", "persona3_summarized_opinion":"summarized opinion from persona 3", "synthesized_tactical_advice_+list":["synthesized unique tactical advice from all personas as a list"]
